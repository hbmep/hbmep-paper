...
def main(
    ...
    def run_experiment(n_subjects, draw, M):
        ...
        a_loc_delta_scale = posterior_samples["a_loc_delta_scale"]
        np.save(os.path.join(model.build_dir, "a_loc_delta_scale.npy"), a_loc_delta_scale)
        ...
        a_loc_delta, a_loc_delta_scale, = None, None
        del config, df, prediction_df, encoder_dict, _
        del model, posterior_samples, posterior_predictive
        del a_loc_delta, a_loc_delta_scale
        gc.collect()
