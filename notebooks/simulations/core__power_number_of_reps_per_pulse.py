...
from constants__power import (
    ...
    REPS_TOTAL_REPS,
    REPS_TOTAL_PULSES,
    REPS_SIMULATE_DATA_WITH_EFFECT_DIR,
    REPS_SIMULATE_DATA_WITH_NO_EFFECT_DIR,
    REPS_EXPERIMENTS_WITH_EFFECT_DIR,
    REPS_EXPERIMENTS_WITH_NO_EFFECT_DIR,
)

logger = logging.getLogger(__name__)
N_PULSES = REPS_TOTAL_PULSES
...
if __name__ == "__main__":
    ...
    main(
        simulation_data_dir=REPS_SIMULATE_DATA_WITH_EFFECT_DIR,
        build_dir=REPS_EXPERIMENTS_WITH_EFFECT_DIR,
    ...
    # main(
    #     simulation_data_dir=REPS_SIMULATE_DATA_WITH_NO_EFFECT_DIR,
    #     build_dir=REPS_EXPERIMENTS_WITH_NO_EFFECT_DIR,
    #     draws_space=draws_space,
    #     n_reps_space=n_reps_space,
    #     n_subjects_space=n_subjects_space,
    #     models=models,
