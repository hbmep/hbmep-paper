...
SIMULATION_DF_PATH = os.path.join(REPS_DIR__ACCURACY, SIMULATION_DF)
SIMULATION_PPD_PATH = os.path.join(REPS_DIR__ACCURACY, INFERENCE_FILE)
BUILD_DIR = EXPERIMENTS_DIR__ACCURACY
    ...
    def run_experiment(
        ...
        match M.NAME:
            case (
                ...
                # Load data
                pulses = reps_map[(n_pulses, n_reps)]
                ind = (
