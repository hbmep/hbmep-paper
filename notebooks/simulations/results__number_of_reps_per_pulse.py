...
from core__number_of_reps_per_pulse import N_SUBJECTS, N_PULSES_SPACE
from constants__accuracy import N_REPS_PER_PULSE_SPACE, NUMBER_OF_REPS_PER_PULSE_DIR
    ...
    for n_reps in n_reps_space:
        for n_pulses in n_pulses_space:
            for draw in draws_space:
                ...
                logger.info(f"n_reps: {n_reps}, n_pulses: {n_pulses}, draw: {draw}")
