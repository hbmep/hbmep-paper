...
# Number of reps per pulse
REPS_SIMULATE_DATA_DIR__POWER = os.path.join(SIMULATE_DATA_DIR__POWER, "number_of_reps_per_pulse")
REPS_SIMULATE_DATA_WITH_EFFECT_DIR = os.path.join(REPS_SIMULATE_DATA_DIR__POWER, "with_effect")
REPS_SIMULATE_DATA_WITH_NO_EFFECT_DIR = os.path.join(REPS_SIMULATE_DATA_DIR__POWER, "no_effect")

REPS_EXPERIMENTS_WITH_EFFECT_DIR = os.path.join(REPS_SIMULATE_DATA_WITH_EFFECT_DIR, "experiments")
REPS_EXPERIMENTS_WITH_NO_EFFECT_DIR = os.path.join(REPS_SIMULATE_DATA_WITH_NO_EFFECT_DIR, "experiments")

REPS_TOTAL_PULSES = 64
REPS_TOTAL_REPS = 8
