...
class PieceWiseSD(BaseModel):
    NAME = "PieceWiseSD"

    def __init__(self, config: Config):
        super(PieceWiseSD, self).__init__(config=config)
    ...
    def _model(self, features, intensity, response_obs=None):
        ...
        with numpyro.plate(site.n_response, self.n_response):
            with numpyro.plate(site.n_data, n_data):
                ...
                beta = numpyro.deterministic(
                    site.beta,
                    G.PieceWiseSD(mu, c_1[feature0], c_2[feature0], c_3[feature0], intensity, a[feature0])
                )
                alpha = numpyro.deterministic(
                    "alpha",
                    jnp.multiply(mu, beta)
...
class PieceWiseVariance(BaseModel):
    NAME = "PieceWiseVariance"

    def __init__(self, config: Config):
        super(PieceWiseVariance, self).__init__(config=config)
    ...
    def _model(self, features, intensity, response_obs=None):
        ...
        with numpyro.plate(site.n_response, self.n_response):
            with numpyro.plate(site.n_data, n_data):
                ...
                beta = numpyro.deterministic(
                    site.beta,
                    G.PieceWiseVariance(mu, c_1[feature0], c_2[feature0], c_3[feature0], intensity, a[feature0])
                )
                alpha = numpyro.deterministic(
                    "alpha",
                    jnp.multiply(mu, beta)
