...
TOTAL_SUBJECTS = 10
TOTAL_PULSES = 101
A_RANDOM_MEAN, A_RANDOM_SCALE = -3.0, 1.5
TOTAL_REPS = 8

POSTERIOR_PATH = "/home/vishu/repos/hbmep-paper/reports/experiments/tms/learn_posterior/inference.pkl"
BUILD_DIR = f"/home/vishu/repos/hbmep-paper/reports/experiments/tms/simulate/a_random_mean_{A_RANDOM_MEAN}_a_random_scale_{A_RANDOM_SCALE}/old"
...
def main():
    ...
    simulation_df = pd.concat([simulation_df] * TOTAL_REPS, ignore_index=True).reset_index(drop=True).copy()
