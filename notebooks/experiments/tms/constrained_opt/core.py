...
BUILD_DIR = "/home/vishu/repos/hbmep-paper/reports/experiments/tms/constrained-opt"
...
def main():
    ...
    def run_experiment(
        ...
        for subject in range(n_subjects):
            ...
            model.render_recruitment_curves(df=df, prediction_df=prediction_df, params=params)

            # Compute error and save results
            a_true = ppd_a[draw, [subject], ...]
            a_pred = np.array([params[0]]).reshape(-1, 1)
