...
def main():
    ...
    root_dir = Path(str(root_dir).replace('ECR', 'FCR'))
    ...
    reduce_muscle_set = ['PKPK_FCR']  #, ['PKPK_FCR'] # None means all muscles. N.B. the implementation of the filtering is the worst imaginable.
    choose_interp = False
