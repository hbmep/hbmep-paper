...
class HierarchicalBayesianModelMixtureOff(GammaModel):
    NAME = "hierarchical_bayesian_model_mixture_off"

    def __init__(self, config: Config):
        super(HierarchicalBayesianModelMixtureOff, self).__init__(config=config)
