...
#                     )
#                     b = numpyro.sample(site.b, dist.Uniform(0., 50.))
...
class MaximumLikelihoodModel(BoundConstrainedOptimization, GammaModel):
    ...
    def __init__(self, config: Config):
        ...
        self.bounds = [(1e-9, 50.), (1e-9, 10), (1e-9, 10), (1e-9, 10), (1e-9, 50), (1e-9, 10), (1e-9, 10)]
        self.informed_bounds = [(2, 8), (1e-3, 5), (1e-4, .1), (1e-2, 5), (.5, 10), (.5, 5), (1e-3, .5)]
        self.num_reinit = 100
        self.n_jobs = -1
    ...
    def cost_function(self, x, y_obs, a, b, L, ell, H, c_1, c_2):
        mu = self.functional(x, a, b, L, ell, H, c_1, c_2)
...
class DefaultHierarchicalBayesianModel(GammaModel):
    ...
    def __init__(self, config: Config):
        super(DefaultHierarchicalBayesianModel, self).__init__(config=config)
