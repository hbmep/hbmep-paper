...
\begin{document}
    ...
    Although attempts are made to filter outliers as much as posssible from the data, there is still a possibility that some outliers remain. To account for this, we use a mixture model to model the data. The mixture model is a combination of two normal distributions, one for the outliers and one for the inliers. The mixture model is defined as follows,
