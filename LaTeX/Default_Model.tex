...
\begin{minipage}{.5\textwidth}
    \begin{figure}[H]
        ...
        \tikz{ %
            ...
            \node[det,above=of obs,xshift=1.2cm,yshift=0cm,fill] (mu) {$\mu_i^p$}; %
            \node[obs,above=of obs,xshift=-.8cm,yshift=1cm,fill] (intensity) {$x_i^p$};%
            \plate[inner sep=.1cm, yshift=.07cm] {plate_obs} {(obs)(mu)(beta)(intensity)} {$i: 1, 2 \ldots N(p)$};

            % % PRIORS
            % a, b, v
            \node[latent,above=of obs,yshift=2.2cm,xshift=-1.3cm,fill] (a) {$a_p$};
            ...
            % g1, g2
            \node[latent,left=of a,xshift=.3cm,fill] (g2) {${c_2}_p$};
            \node[latent,left=of g2,xshift=.9cm,fill] (g1) {${c_1}_p$};
