...
\begin{minipage}{.5\textwidth}
    \begin{figure}[H]
        ...
        \tikz{ %
            ...
            \node[latent,right=of b,xshift=-.9cm,fill] (v) {$v_j$};
            % L, ell, H
            \node[latent,right=of v,xshift=-.9cm,fill] (L) {$L_j$};
            \node[latent,right=of L,xshift=-.9cm,fill] (ell) {$\ell_j$};
            \node[latent,right=of ell,xshift=-.9cm,fill] (H) {$H_j$};
            % g1, g2
