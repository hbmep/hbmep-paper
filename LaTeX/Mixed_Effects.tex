...
\begin{document}
    ...
    \begin{figure}[H]
        ...
        \tikz{ %
            ...
            % % PRIORS
            % a, b, v
            \node[det,above=of obs,yshift=2.2cm,xshift=-1.3cm,fill] (a) {$a$};
            ...
            % g1, g2
            \node[latent,left=of a,xshift=.9cm,fill] (g2) {${c_2}$};
            \node[latent,left=of g2,xshift=.9cm,fill] (g1) {${c_1}$};

            % Participants plate
            \plate[inner sep=.25cm, yshift=.2cm] {plate_participant} {(a)(b)(L)(H)(ell)(g1)(g2)(plate_obs)} {$p:1, 2 \ldots N_P$};
            ...
            % Groups plate
            \plate[inner sep=.25cm, yshift=.2cm] {plate_group} {(b_scale)(g1_scale)(g2_scale)(L_scale)(H_scale)(ell_scale)(plate_participant)} {$h: 1, 2 \ldots N_H$};
