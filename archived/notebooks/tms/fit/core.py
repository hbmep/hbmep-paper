...
dest = "/home/vishu/logs/tms-fit.log"
logging.basicConfig(
    format=FORMAT,
    level=logging.INFO,
    handlers=[
...
class MixtureModel(BaseModel):
    ...
    def _model(self, features, intensity, response_obs=None):
        ...
        with numpyro.plate(site.n_response, self.n_response):
            """ Global Priors """
            a_scale_global_scale = numpyro.sample("a_scale_global_scale", dist.HalfNormal(50.))
...
def main():
    ...
    config.BUILD_DIR = os.path.join(config.BUILD_DIR, "fit", "super-threshold")
