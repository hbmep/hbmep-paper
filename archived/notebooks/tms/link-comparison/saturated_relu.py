...
dest = "/home/vishu/logs/tms-saturated-relu-with-where.log"
logging.basicConfig(
    format=FORMAT,
    level=logging.INFO,
    handlers=[
...
def main():
    ...
    config.BUILD_DIR = os.path.join(config.BUILD_DIR, "link-comparison", "saturated-relu-with-where")
